...
######### COMMENT OUT:
prompt = ""
promptsList = ['red dog', 'blue fish']



def main(prompt, myNumber):
    ...
    model.load_state_dict(_fix_path('/home/vita_rabinovich/ImagenT5-3B/model.pt'))
    ...
    upsampler = RealESRGANer(
        scale=netscale,
        model_path='/home/vita_rabinovich/Real-ESRGAN/experiments/pretrained_models/RealESRGAN_x4plus.pth',
